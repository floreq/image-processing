...
namespace ImagesProcessing
{
    public partial class Form1 : Form
    {
        ...
        static LbphMethods lm = new LbphMethods();
        ...
        private void checkBoxCrossValid_CheckedChanged(object sender, EventArgs e)
        {            
            if (checkBoxCrossValid.Checked)
            {
                OnCompare += Lbph;
            }
            else
        ...
        void Lbph()
        {
            lm.CrossValidation(pi, procededImagesSavePath);
        }
    }
}
